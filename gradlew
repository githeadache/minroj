...
#           bash Gradle
#
#       (2) Maintenance of these scripts is complicated by the fact
#           that they must run on a system where /bin/bash is not available.
#           See https://github.com/nicowillis/nicowillis.github.io
#
##############################################################################
...
if ! "$cygwin" && ! "$darwin" && ! "$nonstop" ; then
    ...
    case $MAX_FD in  #(
      '' | soft) :;; #( No limit, or use the soft limit, then do nothing.
      *)
